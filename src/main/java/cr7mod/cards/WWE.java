...
public class WWE extends CustomCard {
    ...
    private static final int BASE_WEAK = 99;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
            new MakeTempCardInDrawPileAction(new Zhen(), 1, true, false)
        );
    }
