...
public class Benzema extends CustomCard {
    public static final String ID = "CR7Mod:Benzema";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "card_picture/benzema.png";
    ...
    private static final int FANS_LOSE = 3;
    private static final int BASE_BUFFER = 1;
    private static final int UPGRADE_BUFFER = 1;

    public Benzema() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        this.baseMagicNumber = BASE_BUFFER;
    ...
    public void upgrade() {
        if (!this.upgraded) {
            upgradeName();
            upgradeMagicNumber(UPGRADE_BUFFER);
        }
    }
