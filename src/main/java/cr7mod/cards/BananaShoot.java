...
public class BananaShoot extends CustomCard {
    public static final String ID = "CR7Mod:BananaShoot";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "card_picture/banana_shoot.png";
    ...
    private static final int FANS_THRESHOLD = 12;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        // Determine number of hits: 2 if Fans >= threshold, otherwise 1
        int hits = 1;
        AbstractPower fp = p.getPower(FansPower.POWER_ID);
        if (fp != null && fp.amount >= FANS_THRESHOLD) hits = 2;
