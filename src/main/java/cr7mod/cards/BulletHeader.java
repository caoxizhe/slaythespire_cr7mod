...
public class BulletHeader extends CustomCard {
    public static final String ID = "CR7Mod:BulletHeader";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "card_picture/bullet_header.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(
            new DamageAllEnemiesAction(
                p, 
                this.multiDamage, 
                DamageInfo.DamageType.HP_LOSS, AttackEffect.BLUNT_HEAVY)
        );
        AbstractDungeon.actionManager.addToBottom(
