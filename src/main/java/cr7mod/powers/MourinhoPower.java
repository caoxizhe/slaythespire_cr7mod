...
public class MourinhoPower extends AbstractPower {
    public static final String POWER_ID = "CR7Mod:MourinhoPower";
    private static final PowerStrings POWER_STRINGS = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public MourinhoPower(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    private void loadIcon() {
        Texture tex84 = new Texture("powers/mourinho_84.png");
        Texture tex32 = new Texture("powers/mourinho_32.png");
